	<table class="table table-striped table-bordered">
		<thead>
			<thead>
				<tr>
					...
					<!--
					<th class="hidden-phone" style="width:10%;"><?php //echo lang('sku');?></th>
		...
		<tfoot>
			...
			**************************************************************/
        	...
        	<tr>
				<td colspan="3"><strong><?php echo lang('group_discount');?></strong></td>
				<td><?php echo format_currency(0-$this->go_cart->group_discount()); ?>                </td>
			</tr>
			<?php endif; ?>
			<tr>
		    	<td colspan="3"><strong><?php echo lang('subtotal');?></strong></td>
			...
			**************************************************************/
			...
			if($this->config->item('tax_shipping') && $this->go_cart->shipping_cost()>0) : ?>
				...
				<td colspan="3"><strong><?php echo lang('shipping');?></strong></td>
		    ...
		    <tr>
				...
				<td colspan="3"><strong><?php echo lang('tax');?></strong></td>
			...
			**************************************************************/
			...
			<tr>
				...
				<td colspan="3"><strong><?php echo lang('gift_card_discount');?></strong></td>
		...
		<tbody>
			...
			foreach ($this->go_cart->contents() as $cartkey=>$product):?>
				<tr>
					...
					<!--
					<td class="hidden-phone"><?php echo $product['sku']; ?></td>
